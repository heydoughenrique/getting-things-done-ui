...
export default function MenuSimpleCentered() {
  ...
  return (
    <Flex pos='fixed' w='100vw' background='white' minH='80px' zIndex='9999'>
      <Flex
        mx='auto'
        align='center'
      ...
      >
        <Flex w={[140, 160]}>
          <Link href='/' passHref>
            <Image src='/images/logo.svg' alt='Strides Logo' />
          </Link>
        </Flex>
      ...
      >
        ...
        <Flex flexDir='column' align='center'>
          ...
          <Stack justify={'flex-end'} direction={'column'} width='90vw'>
            <Button as='a' variant='ghost' aria-label={t.menu.login} w='100%'>
              {t.menu.login}
            </Button>
            <Button
              as='a'
            ...
            <Select onChange={changeLanguage} defaultValue={locale} w='100%'>
              <option value='en'>EN-US</option>
              <option value='pt'>PT-BR</option>
            </Select>
          </Stack>
